...
from tableauserverclient.models import (
    ConnectionItem, DataAlertItem, FlowItem, MetricItem, ProjectItem,
    SiteItem, SubscriptionItem, TaskItem, UserItem, GroupItem, PermissionsRule, FavoriteItem,
    WebhookItem
)
...
if TYPE_CHECKING:
    from tableauserverclient.models import DataAlertItem, FlowItem,\
        ConnectionItem, SiteItem, SubscriptionItem, ProjectItem
