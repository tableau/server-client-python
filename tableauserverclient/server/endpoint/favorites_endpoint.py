...
from .. import RequestFactory, RequestOptions, UserItem, ViewItem, \
               ProjectItem, WorkbookItem, DatasourceItem
...
class Favorites(Endpoint):
    ...
    # Gets all favorites
    @api(version="2.5")
    def get(self, user_item: UserItem, req_options: RequestOptions = None):
    ...
    @api(version="2.0")
    def add_favorite_workbook(self, user_item: UserItem, workbook_item: WorkbookItem):
        url = '{0}/{1}'.format(self.baseurl, user_item.id)
    ...
    @api(version="2.0")
    def add_favorite_view(self, user_item: UserItem, view_item: ViewItem):
        url = '{0}/{1}'.format(self.baseurl, user_item.id)
    ...
    @api(version="2.3")
    def add_favorite_datasource(self, user_item: UserItem, datasource_item: DatasourceItem):
        url = '{0}/{1}'.format(self.baseurl, user_item.id)
    ...
    @api(version="3.1")
    def add_favorite_project(self, user_item: UserItem, project_item: ProjectItem):
        url = '{0}/{1}'.format(self.baseurl, user_item.id)
    ...
    @api(version="2.0")
    def delete_favorite_workbook(self, user_item: UserItem, workbook_item: WorkbookItem):
    ...
    @api(version="2.0")
    def delete_favorite_view(self, user_item: UserItem, view_item: ViewItem):
    ...
    @api(version="2.3")
    def delete_favorite_datasource(self, user_item: UserItem, datasource_item: DatasourceItem):
    ...
    @api(version="3.1")
    def delete_favorite_project(self, user_item: UserItem, project_item: ProjectItem):
