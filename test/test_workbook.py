...
class WorkbookTests(unittest.TestCase):
    ...
    def test_update(self):
        ...
        with requests_mock.mock() as m:
            ...
            single_workbook.materialized_views_config = {
        ...
        self.assertEqual(
            True,
            single_workbook.materialized_views_config["materialized_views_enabled"],
        )
        self.assertEqual(
            False, single_workbook.materialized_views_config["run_materialization_now"]
        )
