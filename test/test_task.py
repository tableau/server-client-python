...
class TaskTests(unittest.TestCase):
    ...
    def test_get_materializeviews_tasks(self):
        ...
        self.assertEqual('2019-12-09T22:30:00Z', task.schedule_next_run_at)
        self.assertEqual('2019-12-09T20:45:04Z', task.schedule_last_run_at)

    def test_delete(self):
        with requests_mock.mock() as m:
            m.delete('{}/materializedViews/{}'.format(
                self.server.tasks.baseurl, 'c9cff7f9-309c-4361-99ff-d4ba8c9f5467'), status_code=204)
            self.server.tasks.delete_task_type_and_id('materializedViews',
