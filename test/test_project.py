...
class ProjectTests(unittest.TestCase):
    ...
    def test_get(self):
        ...
        self.assertEqual('19093a92-6ef0-4443-aef9-dc9b446f0cd7', all_projects[0].owner_id)
        ...
        self.assertEqual('33fa8f97-2102-407f-b8de-e2dd6969f4b2', all_projects[1].owner_id)
        ...
        self.assertEqual('33fa8f97-2102-407f-b8de-e2dd6969f4b2', all_projects[2].owner_id)
